...
const Footer = () => {
  ...
  const fusername = localStorage.getItem("username");
  const role = localStorage.getItem("role");


  const sumbitFeedback = (e) => {
    e.preventDefault();
    navigate("/feedback");
    ...
    <>
      ...
      <div className="extra">
        ...
        <div className="privacytag">
          ...
          {role == "ADMIN" ? 
          <button className="feedback" onClick={getfeedback}>Feedback</button> :
          <button></button>
          }
