...
import { categories_admin } from "../AdminPage/categories_admin";
import Category from "../Category/Category";
// import { VideoData } from "../Homepage/data";
import axios from "axios";
import { useEffect } from "react";
import { ManagerUserDetail, MbanUserB } from "../../service/api";
// import { AdminUserDetail, TdeleteUser, banUserB } from "../../service/api";
...
const Manager = () => {
  ...
  const allBannedUser=()=>{
    axios.get(`http://localhost:8080/api/management/getUserOfBan`).
    then((res)=>{
       setUsers(res.data)
      console.log(res);
    })
